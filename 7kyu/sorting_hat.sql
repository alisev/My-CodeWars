...
-- its decision-making powers are common operators and prospectIve students are merely data - names, and two columns of qualities.
...
WHERE quality1 = 'evil' AND quality2 = 'cunning'        -- Slytherin
  OR quality1 = 'brave' AND NOT quality2 = 'evil'       -- Gryffindor
  OR quality1 = 'studious' OR quality2 = 'intelligent'  -- Ravenclaw
  OR quality1 = 'hufflepuff' OR quality2 = 'hufflepuff' -- Hufflepuff
ORDER BY id
